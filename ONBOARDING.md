...
- **Strike selection is open-interest–weighted** (Laura's roll-ability rule): among the strikes that pass each leg's rule (sold put ≤ spot within ~4%; bought put ≥42% credit within ±5% of the ~40pt/20% width target; call in the ideal **45–55% I/E band first**, widening to 40–60% only if that's empty), pick the one with the **higher open interest** — usually the round/even strike — so future rolls fill cleanly. Best-fit (closest ATM / width / 50-50) is the tiebreak and the fallback when OI is missing. The call leg's ideal-band-first rule ensures a marginally-more-liquid strike can't drag the pick off 50/50 (e.g. it keeps a 52/48 @ 2.8k OI over a 42/58 @ 4.1k OI). Lands on Laura's own picks (NVDA @ ~$196 → sell 190P / buy 150P / buy 160C).
